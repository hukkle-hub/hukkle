...
for (const region of regions) {
  ...
  await page.goto(`http://127.0.0.1:4175/admin/dungeon-flow.html?region=${region}&v=79.0.0`, { waitUntil:'networkidle' });
